    ...
    <div class="job-management">
        ...
        <cron v-if="showCronBox" v-model="dialogForm.jobCron"></cron>
            ...
            >
                ...
                >
                    <fu-input
                        clearable
                        v-model="dialogForm.scheduleName"
                    ></fu-input>
                </fu-form-item>
                <fu-form-item
                    label="cron表达式"
            ...
            <span slot="footer" class="dialog-footer">
                <fu-button type="primary" @click="createOrUpdateJob"
                    >确 定</fu-button
                >
        ...
        >
            <template v-if="logDialogVisible">
                ...
                <span slot="footer" class="dialog-footer">
                    <fu-button @click="logDialogVisible = false"
                        >关 闭</fu-button
                    >
                </span>
            </template>
        ...
        >
            ...
            <span slot="footer" class="dialog-footer">
                <fu-button type="primary" @click="addOrEditFolder"
                    >确 定</fu-button
                >
                <fu-button @click="folderDialogVisible = false"
                    >取 消</fu-button
                >
            </span>
        </fu-dialog>
...
export default {
                ...
                params: [
                    {
                        ...
                        data: {
                            ...
                            triggerTime:
                                this.logQueryForm.triggerTime.join(' - '),
                            handleTime:
                                this.logQueryForm.handleTime.join(' - '),
    ...
    methods: {
        ...
        funIndex(index) {
            return (
                (this.tableData.page - 1) * this.tableData.pagerows + index + 1
            )
        },
        //表格分页切换
        ...
        funLogIndex(index) {
            return (
                (this.dialogTableData.page - 1) *
                    this.dialogTableData.pagerows +
                index +
                1
            )
        },
