...
// job日志查询,运行历史查看日志调这个
const QUERY_JOB_LOG_URL_DETAIL =
  "/api/schedulecenter/v1/joblog/queryPollingDetail.do";
...
/**
 * @description job日志查询,运行历史查看日志调这个
 */
export const queryJobDeatil = (executionId, taskId) => {
  return postJSON(QUERY_JOB_LOG_URL_DETAIL, {
    postData: JSON.stringify({
      data: [
        { vtype: "attr", name: "id", data: executionId },
        { vtype: "attr", name: "taskId", data: taskId },
      ],
    }),
  });
