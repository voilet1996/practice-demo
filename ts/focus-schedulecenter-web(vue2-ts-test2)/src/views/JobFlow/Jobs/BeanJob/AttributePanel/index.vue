<template>
  <fu-tabs v-model="activeName">
    ...
    <fu-tab-pane label="Bean任务设置" name="BeanJob">
      <div class="mappingsetContainer" v-if="activeName === 'BeanJob'">
        <fu-form :rules="rules" :fu-data="taskData.BeanJob">
          <fu-form-item
            label="JobHandler"
            label-width="110px"
            prop="serviceUrl"
          >
            <fu-input v-model="taskData.BeanJob.serviceUrl"></fu-input>
          </fu-form-item>
        </fu-form>
      </div>
    </fu-tab-pane>
